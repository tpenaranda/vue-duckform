(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vee-validate/dist/rules'), require('vee-validate'), require('vue-range-slider'), require('vue-range-slider/dist/vue-range-slider.css'), require('vue-date-pick/dist/vueDatePick.css'), require('vue-date-pick'), require('moment'), require('axios'), require('lodash')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vee-validate/dist/rules', 'vee-validate', 'vue-range-slider', 'vue-range-slider/dist/vue-range-slider.css', 'vue-date-pick/dist/vueDatePick.css', 'vue-date-pick', 'moment', 'axios', 'lodash'], factory) :
  (global = global || self, factory(global.Duckform = {}, global.rules, global.veeValidate, global.rangeSlider, null, null, global.datePick, global.moment, global.axios, global._));
}(this, (function (exports, rules, veeValidate, RangeSlider, vueRangeSlider_css, vueDatePick_css, DatePick, moment, axios, _) { 'use strict';
